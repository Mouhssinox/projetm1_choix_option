...
<body class="nav-md" onload="hidden_drop(0)">
  ...
  <div class="container body">
    ...
    <div class="main_container">
       <form action="choix-update.php" method="POST">
      ...
      <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="x_panel">
                              <div class="x_title">
                                <h2>Ancien choix d'options<small>L3</small></h2>
        ...
        <table class="table table-bordered">
          ...
          try
                        {
                        $sel = $bdd->prepare('SELECT O.nom,O.id_option FROM `options` AS O,`etudiants` AS E,`choix_etudiant` AS C WHERE E.ine = C.ine and O.id_option = C.id_option and E.ine = :ine order by C.choix_etudiant');
                        $sel->execute(array(
                        'ine' => $_SESSION["identifiantEtudiant"]
                        ));
                        $i=1;
...
<?php
                    ...
                    ?>
                    <tr><td colspan="4"><center><button type="submit" class="btn btn-default btn-success submit" >Modifier</button><button type="reset" class="btn btn-default btn-info">Reset</button></center></td></tr>
                                  </tbody>
                                </table>
