				  ...
				  <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
					...
					<div class="menu_section">
					  ...
					  <ul class="nav side-menu">
						...
						<li><a><i class="fa fa-desktop"></i> Lancer les options <span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu" style="display: none">
						...
						<ul class="nav navbar-nav navbar-right">
						  <li class="">
							...
							<ul class="dropdown-menu dropdown-usermenu pull-right">
							  <li><a href="destroy.php"><i class="fa fa-sign-out pull-right"></i> Déconnexion</a>
							  </li>
							</ul>
						  </li>
						</ul>
			...
			<div class="right_col" role="main">
				...
				<div class="page-title">
					<div class="title_left">
						<h3>Liste des options prévues à ouvrir en S6</h3>
					</div>
				</div>
										...
										<div class="modal-dialog" role="document">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form method="post" action="insertion-options6.php" id="form-insertion" data-parsley-validate class="form-horizontal form-label-left">
														...
														<div class="form-group">
														  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Id_Option">ID de l'Option<span class="required">*</span>
														  </label>
														  <div class="col-md-6 col-sm-6 col-xs-12">
															<input type="text" id="Id_Option" name="Id_Option" required="required" class="form-control col-md-7 col-xs-12">
														  </div>
														</div>
								...
								<div class="modal fade" id="ModalUpload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
												<h4 class="modal-title">Upload options</h4>
											</div>
											<div class="modal-body">
												<form enctype="multipart/form-data" method="post" action="upload-options.php" id="form-upload" data-parsley-validate class="form-horizontal form-label-left dropzone">
								...
								<table class="table table-hover">
									<thead>
										<tr>
											<th>Nom</th>
											<th>Site</th>
											<th>Max des étudiants</th>
											<!--<th>Numéro de l'option</th>-->
											<th>Identifient de l'option</th>
											<th>m</th><!-- modification -->
											<th>s</th><!-- Suppresion -->
											<th>o</th><!-- ouverture des options -->
										</tr>
									</thead>
									<tbody>
											<form action="ouverture_Option.php" method="POST">
										...
										<?php
											...
											{
												$bdd = new PDO('mysql:host=localhost;dbname=projetm1','root','');
												$reponse = $bdd->query('select * from options_ouvertes');
												
												while($donne = $reponse->fetch()){

													print ("<tr>");
									print("<td><input type='hidden' name='nomOption' value='".$donne['nom_opt']."'>".$donne['nom_opt']."</td>");
									print("<td><input type='hidden' name='siteOption' value='".$donne['site_opt']."'>".$donne['site_opt']."</td>");
							print("<td><input type='hidden' name='maxEtudiant' value='".$donne['max_etu_opt']."'>".$donne['max_etu_opt']."</td>");
												//	print('<td>'.$donne['numero_option'].'</td>');
									print('<td>'.$donne['id_option'].'</td>');
													print ('<td><a href="modificaton-option_S6.php?numero='.$donne['id_option'].'"><i class="fa fa-edit"></i></a></td>');
													print ('<td><a href="suppression-option_S6.php?numero='.$donne['id_option'].'"><i class="fa fa-trash"></i></a></td>');
													print ("<td><input type='checkbox' name='ID[]' value='".$donne['id_option']."'/></td>");
													print ("</tr>");
												}
										...
										<tr><td></td><td></td><td></td><td></td><td></td><td></td><td>
												<input type="submit" name="ouvrir" class="btn btn-info" value="Ouvrir">
													</td></tr>
										</form>	
									</tbody>
								</table>
