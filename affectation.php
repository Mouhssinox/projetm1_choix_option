			...
			<div class="right_col" role="main">
				...
				<div class="page-title">
					<?php
						...
						{
							if($_GET['succes']){
								print ('<div class="title_center" style="color:red"><h1>afféctation échouée</h1></div>');
							}
						}
					?>
						<div class="title_left">
							<h3>requette éfféctué par les étudiants</h3>
						</div>
						...
						<div class="x_panel">
							...
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									<li><button onclick='self.location="algo.php"'>cliquer pour lancer l'affectation</button></li>
								</ul>
								<div class="clearfix"></div>
							</div>
								...
								<table class="table table-hover">
									...
									<tbody>
										<?php
											...
											{
												$bdd = new PDO('mysql:host=localhost;dbname=projetm1','root','');
												$reponse = $bdd->query('select choix_etudiant.ine,etudiants.nom as nom_etu,prenom,numero_option,options.nom as nom_opt,choix_etudiant 
																		from choix_etudiant 
																		join etudiants on choix_etudiant.ine=etudiants.ine 
																		join options on choix_etudiant.id_option=options.id_option 
																		order by choix_etudiant.ine,numero_option,choix_etudiant');
												while($donne = $reponse->fetch()){
													print ('<tr>');
													print ('<td>'.$donne['ine'].'</td>');
													print ('<td>'.$donne['nom_etu'].'</td>');
													print ('<td>'.$donne['prenom'].'</td>');
													print ('<td>'.$donne['numero_option'].'</td>');
													print ('<td>'.$donne['nom_opt'].'</td>');
													print ('<td>'.$donne['choix_etudiant'].'</td>');
													print '</tr>';
												}
