			...
			<!-- corps -->
				<div class="right_col" role="main">
					...
					<div class="page-title">
						...
						{
							if($_GET['succes']){
								print ('<div class="title_center" style="color:green"><h1>afféctation réussi</h1></div>');
							}
						}
					?>
						
						<div class="title_left">
							<h3>Résultat pour tout les étudiants</h3>
						</div>
					</div>
						...
						<div class="x_panel">
							...
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									<li>
										<a href="create_pdf.php?tout=true" ><i class="fa fa-file-pdf-o"></i></a>
									</li>
								</ul>
								<div class="clearfix"></div>
							</div>
