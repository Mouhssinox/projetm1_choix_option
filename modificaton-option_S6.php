    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
          ...
          <div class="title_left">
            <h3>Liste des options à modifier</h3>
          </div>
          </div>
                    ...
                    <?php
                      try
                      { print ("<form name='modification' action='bienModifier.php' method='POST' >");
                        $bdd = new PDO('mysql:host=localhost;dbname=projetm1','root','');
                        $reponse = $bdd->query("select * from options_ouvertes where id_option='".$_GET['numero']."'");
                        while($donne = $reponse->fetch()){
                          
                          print('<input type="text" name="nomOption" value="'.$donne['nom_opt'].'">');
                          /*print('<input type="text" name="siteOption" value="'.$donne['site_opt'].'">');*/
                          print("<input type='checkbox' name='Sites[]'  value='luminy'/>Luminy");
                          print("<input type='checkbox' name='Sites[]'  value='saint charles'/>Saint charles");
                          print("<input type='checkbox' name='Sites[]'  value='aix-en-provence'/>aix-en-provence");


                          print('<input type="text" name="maxEtudient" value="'.$donne['max_etu_opt'].'">');
                          print('<input type="hidden" name="IdOption" value="'.$donne['id_option'].'">');
